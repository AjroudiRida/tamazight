 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class y extends Error{constructor(t){super(`[GoogleGenerativeAI Error]: ${t}`)}}class S extends y{constructor(t,s){super(t),this.response=s}}class ae extends y{constructor(t,s,n,i){super(t),this.status=s,this.statusText=n,this.errorDetails=i}}class L extends y{}class le extends y{}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ve="https://generativelanguage.googleapis.com",Ee="v1beta",be="0.24.0",Te="genai-js";var N;(function(e){e.GENERATE_CONTENT="generateContent",e.STREAM_GENERATE_CONTENT="streamGenerateContent",e.COUNT_TOKENS="countTokens",e.EMBED_CONTENT="embedContent",e.BATCH_EMBED_CONTENTS="batchEmbedContents"})(N||(N={}));class ye{constructor(t,s,n,i,o){this.model=t,this.task=s,this.apiKey=n,this.stream=i,this.requestOptions=o}toString(){var t,s;const n=((t=this.requestOptions)===null||t===void 0?void 0:t.apiVersion)||Ee;let o=`${((s=this.requestOptions)===null||s===void 0?void 0:s.baseUrl)||ve}/${n}/${this.model}:${this.task}`;return this.stream&&(o+="?alt=sse"),o}}function _e(e){const t=[];return e!=null&&e.apiClient&&t.push(e.apiClient),t.push(`${Te}/${be}`),t.join(" ")}async function Ie(e){var t;const s=new Headers;s.append("Content-Type","application/json"),s.append("x-goog-api-client",_e(e.requestOptions)),s.append("x-goog-api-key",e.apiKey);let n=(t=e.requestOptions)===null||t===void 0?void 0:t.customHeaders;if(n){if(!(n instanceof Headers))try{n=new Headers(n)}catch(i){throw new L(`unable to convert customHeaders value ${JSON.stringify(n)} to Headers: ${i.message}`)}for(const[i,o]of n.entries()){if(i==="x-goog-api-key")throw new L(`Cannot set reserved header name ${i}`);if(i==="x-goog-api-client")throw new L(`Header name ${i} can only be set using the apiClient field`);s.append(i,o)}}return s}async function Ce(e,t,s,n,i,o){const r=new ye(e,t,s,n,o);return{url:r.toString(),fetchOptions:Object.assign(Object.assign({},Re(o)),{method:"POST",headers:await Ie(r),body:i})}}async function G(e,t,s,n,i,o={},r=fetch){const{url:l,fetchOptions:p}=await Ce(e,t,s,n,i,o);return Ae(l,p,r)}async function Ae(e,t,s=fetch){let n;try{n=await s(e,t)}catch(i){Oe(i,e)}return n.ok||await xe(n,e),n}function Oe(e,t){let s=e;throw s.name==="AbortError"?(s=new le(`Request aborted when fetching ${t.toString()}: ${e.message}`),s.stack=e.stack):e instanceof ae||e instanceof L||(s=new y(`Error fetching from ${t.toString()}: ${e.message}`),s.stack=e.stack),s}async function xe(e,t){let s="",n;try{const i=await e.json();s=i.error.message,i.error.details&&(s+=` ${JSON.stringify(i.error.details)}`,n=i.error.details)}catch{}throw new ae(`Error fetching from ${t.toString()}: [${e.status} ${e.statusText}] ${s}`,e.status,e.statusText,n)}function Re(e){const t={};if((e==null?void 0:e.signal)!==void 0||(e==null?void 0:e.timeout)>=0){const s=new AbortController;(e==null?void 0:e.timeout)>=0&&setTimeout(()=>s.abort(),e.timeout),e!=null&&e.signal&&e.signal.addEventListener("abort",()=>{s.abort()}),t.signal=s.signal}return t}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const se=["text","inlineData","functionCall","functionResponse","executableCode","codeExecutionResult"],$e={user:["text","inlineData"],function:["functionResponse"],model:["text","functionCall","executableCode","codeExecutionResult"],system:["text"]};function Ue(e){let t=!1;for(const s of e){const{role:n,parts:i}=s;if(!t&&n!=="user")throw new y(`First content should be with role 'user', got ${n}`);if(!Y.includes(n))throw new y(`Each item should include role field. Got ${n} but valid roles are: ${JSON.stringify(Y)}`);if(!Array.isArray(i))throw new y("Content should have 'parts' property with an array of Parts");if(i.length===0)throw new y("Each Content should have at least one part");const o={text:0,inlineData:0,functionCall:0,functionResponse:0,fileData:0,executableCode:0,codeExecutionResult:0};for(const l of i)for(const p of se)p in l&&(o[p]+=1);const r=$e[n];for(const l of se)if(!r.includes(l)&&o[l]>0)throw new y(`Content with role '${n}' can't contain '${l}' part`);t=!0}}function ne(e){var t;if(e.candidates===void 0||e.candidates.length===0)return!1;const s=(t=e.candidates[0])===null||t===void 0?void 0:t.content;if(s===void 0||s.parts===void 0||s.parts.length===0)return!1;for(const n of s.parts)if(n===void 0||Object.keys(n).length===0||n.text!==void 0&&n.text==="")return!1;return!0}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ie="SILENT_ERROR";class Ve{constructor(t,s,n,i={}){this.model=s,this.params=n,this._requestOptions=i,this._history=[],this._sendPromise=Promise.resolve(),this._apiKey=t,n!=null&&n.history&&(Ue(n.history),this._history=n.history)}async getHistory(){return await this._sendPromise,this._history}async sendMessage(t,s={}){var n,i,o,r,l,p;await this._sendPromise;const _=z(t),O={safetySettings:(n=this.params)===null||n===void 0?void 0:n.safetySettings,generationConfig:(i=this.params)===null||i===void 0?void 0:i.generationConfig,tools:(o=this.params)===null||o===void 0?void 0:o.tools,toolConfig:(r=this.params)===null||r===void 0?void 0:r.toolConfig,systemInstruction:(l=this.params)===null||l===void 0?void 0:l.systemInstruction,cachedContent:(p=this.params)===null||p===void 0?void 0:p.cachedContent,contents:[...this._history,_]},x=Object.assign(Object.assign({},this._requestOptions),s);let m;return this._sendPromise=this._sendPromise.then(()=>ue(this._apiKey,this.model,O,x)).then(h=>{var T;if(ne(h.response)){this._history.push(_);const A=Object.assign({parts:[],role:"model"},(T=h.response.candidates)===null||T===void 0?void 0:T[0].content);this._history.push(A)}else{const A=R(h.response);A&&console.warn(`sendMessage() was unsuccessful. ${A}. Inspect response object for details.`)}m=h}),await this._sendPromise,m}async sendMessageStream(t,s={}){var n,i,o,r,l,p;await this._sendPromise;const _=z(t),O={safetySettings:(n=this.params)===null||n===void 0?void 0:n.safetySettings,generationConfig:(i=this.params)===null||i===void 0?void 0:i.generationConfig,tools:(o=this.params)===null||o===void 0?void 0:o.tools,toolConfig:(r=this.params)===null||r===void 0?void 0:r.toolConfig,systemInstruction:(l=this.params)===null||l===void 0?void 0:l.systemInstruction,cachedContent:(p=this.params)===null||p===void 0?void 0:p.cachedContent,contents:[...this._history,_]},x=Object.assign(Object.assign({},this._requestOptions),s),m=ce(this._apiKey,this.model,O,x);return this._sendPromise=this._sendPromise.then(()=>m).catch(h=>{throw new Error(ie)}).then(h=>h.response).then(h=>{if(ne(h)){this._history.push(_);const T=Object.assign({},h.candidates[0].content);T.role||(T.role="model"),this._history.push(T)}else{const T=R(h);T&&console.warn(`sendMessageStream() was unsuccessful. ${T}. Inspect response object for details.`)}}).catch(h=>{h.message!==ie&&console.error(h)}),m}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
</table></div><p>Les proverbes et formules de politesse sont traités avec soin. Ils gardent leur sens culturel profond.</p><p>Idéal pour les zones rurales, il s'adapte à tous les usages. Parfait pour voyager, étudier ou faire des affaires.</p><h2>Google Traduction : forces et faiblesses pour le Tamazight</h2><p>Depuis son lancement, <em>google traduction tamazight</em> a ouvert des perspectives, mais reste perfectible. L'intégration du tamazight en 2019 a marqué un pas important. Mais, elle repose sur des défis uniques.</p><h3>Historique de l’intégration des langues berbères</h3><p>Google a progressé en collectant des corpus linguistiques. Mais, la standardisation récente du tamazight complique l'adaptation. Les dialectes régionaux, comme le Tachelhit ou le Tarifit, restent mal couverts malgré les efforts.</p><h3>Limites actuelles du système</h3><ul class="list-points">
